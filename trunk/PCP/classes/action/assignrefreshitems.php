...
class action_assignrefreshitems extends action_refreshitems
{	
	...
	public function __construct()
	{
		// init this event
		parent::__construct();
		$this->label = 'Assign value and item refresh';
		$this->description = 'Assign a new value to a session variable then refresh any items. Example: $door_open = 1;';	
	}
