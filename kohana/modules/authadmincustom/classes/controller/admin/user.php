...
class Controller_Admin_User extends Controller_Template_App {
   ...
   public function action_index() {
      ...
      $this->template->content = View::factory('admin/user/index')->set('users', $result)->set('paging', $pagination)->set('default_sort', $sort);
   ...
   public function action_delete($id = NULL) {
      ...
      $this->template->content = View::factory('admin/user/delete')->set('id', $id)->set('data', array('username' => $user->username));
   }
}
