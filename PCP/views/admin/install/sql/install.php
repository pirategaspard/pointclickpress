...
/*data*/
$q = "INSERT INTO `containers_events` (`container_id`, `event_id`) VALUES
(25, 39);";
$results = DB::Query(NULL,$q,FALSE)->execute(); 
...
(28, 2, 25, 'Grate', 'The Path ends abruptly at a grate. Maybe you can break it open!', 'pipe1.jpg', 'hammer'),
(29, 2, 25, 'Grate', 'A piece of the grate is broken, do you dare climb through?', 'pipe2.jpg', 'open'),
(36, 2, 26, 'tunnel', '', 'tunnel.jpg', ''),
(37, 2, 27, 'tunnel2', '', 'tunnel2.jpg', ''),
(38, 2, 28, 'Ocean - The End!', 'You are at the ocean! \nTHE END', 'ocean.JPG', ''),
(39, 2, 29, 'Forest', 'You are in the forest. There is a path in front of you.', 'forest.JPG', 'no_hammer'),
(40, 2, 29, 'Forest', 'You are in the Forest. There is a path in front of you. Someone has left a poorly-drawn sledge hammer here!', 'forest2.JPG', 'hammer'),
(41, 2, 25, 'Grate', 'The Path ends abruptly at a grate. If only you had something to smash it with...', 'pipe1.jpg', 'no_hammer')";
$results = DB::Query(NULL,$q,FALSE)->execute();
