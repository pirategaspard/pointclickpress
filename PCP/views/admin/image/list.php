		...
		<fieldset>
			...
			<table>
				...
				<tr>
					...
					<td><a href="<?php echo(Url::site(Route::get('admin')->uri(array('controller'=>'image','action'=>'edit'))).'?image_id='.$image->id.'&story_id='.$story_id.'&scene_id='.$scene_id.'&itemimage_id='.$itemimage_id); ?>" >Edit</a></td>
					<td>
