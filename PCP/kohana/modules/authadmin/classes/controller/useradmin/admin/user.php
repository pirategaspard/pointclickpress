...
class Controller_Useradmin_Admin_User extends Controller_App {
   ...
   public function action_index() {
      ...
      $this->template->content = View::factory('admin/user/admin/index')->set('users', $result)->set('paging', $pagination)->set('default_sort', $sort);
   ...
   public function action_edit($id = NULL) {
      ...
      $view = View::factory('admin/user/admin/edit');
